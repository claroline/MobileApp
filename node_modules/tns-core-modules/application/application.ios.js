...
var RootViewControllerImpl = (function (_super) {
    __extends(RootViewControllerImpl, _super);
    function RootViewControllerImpl() {
        _super.apply(this, arguments);
    }
    Object.defineProperty(RootViewControllerImpl.prototype, "contentController", {
        get: function () {
    ...
    RootViewControllerImpl.prototype.viewDidLoad = function () {
...
var IOSApplication = (function () {
    ...
    IOSApplication.prototype.didFinishLaunchingWithOptions = function (notification) {
        ...
        if (rootView instanceof frame_1.Frame) {
            var rootController = new RootViewControllerImpl();
