    ...
    RadListView.prototype._updateHeaderFooterAvailability = function () {
        if (this.ios.layout) {
            ...
            if (tempView) {
                ...
                this.listViewLayout.ios.headerReferenceSize = CGSizeMake(measuredSize.measuredWidth, measuredSize.measuredHeight);
                this._removeView(tempView);
            }
            else {
                this.listViewLayout.ios.headerReferenceSize = CGSizeMake(0, 0);
            }
            ...
            if (tempView) {
                ...
                tempView.bindingContext = this.bindingContext;
                var measuredSize = this.measureCell(tempView);
                this.listViewLayout.ios.footerReferenceSize = CGSizeMake(measuredSize.measuredWidth, measuredSize.measuredHeight);
                this._removeView(tempView);
            }
            else {
                this.listViewLayout.ios.footerReferenceSize = CGSizeMake(0, 0);
            }
            this.refresh();
        }
    };
