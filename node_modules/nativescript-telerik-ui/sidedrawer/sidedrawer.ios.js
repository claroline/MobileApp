...
; //todo: consider usage of this type for custom styling
////////////////////////////////////////////////
var RadSideDrawer = (function (_super) {
    ...
    RadSideDrawer.prototype.onMeasure = function (widthMeasureSpec, heightMeasureSpec) {
        ...
        if (this.showOverNavigation) {
            drawerWidth = utils.layout.makeMeasureSpec(UIScreen.mainScreen().bounds.size.width, utils.layout.EXACTLY);
            drawerHeight = utils.layout.makeMeasureSpec(UIScreen.mainScreen().bounds.size.height, utils.layout.EXACTLY);
        }
        if (pos == TKSideDrawerPosition.TKSideDrawerPositionTop || pos == TKSideDrawerPosition.TKSideDrawerPositionBottom) {
